...
namespace LibraryClient.Controllers
{
    public class AuteursController : Controller
    {
        ...
        public AuteursController(LibraryClientContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nom,Prenom,Image,DateNaissance,DateDeces,Biographie")] Auteur auteur)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nom,Prenom,Image,DateNaissance,DateDeces,Biographie")] Auteur auteur)
        {
            if (id != auteur.Id)
            {
                return NotFound();
